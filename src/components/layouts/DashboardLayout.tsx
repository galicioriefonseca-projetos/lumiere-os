             ...
             <div className="relative">
                ...
                {isUserMenuOpen && (
                  <>
                    ...
                    />
                    <div className="absolute right-0 mt-2 w-56 rounded-xl bg-[#09090b] border border-white/10 shadow-[0_10px_30px_rgba(0,0,0,0.8)] p-1.5 z-40 animate-in fade-in slide-in-from-top-1 duration-150">
                      ...
                      <button 
                        ...
                        className="flex items-center gap-2.5 w-full px-2.5 py-2 text-xs rounded-lg text-zinc-300 hover:text-white hover:bg-white/[0.03] transition-all cursor-pointer text-left w-full"
                      >
                      ...
                      <button 
                        onClick={() => {
                          ...
                          window.open(`https://wa.me/5517996140963?text=${encodeURIComponent(text)}`, '_blank');
                        }}
                        className="flex items-center gap-2.5 w-full px-2.5 py-2 text-xs rounded-lg text-zinc-300 hover:text-white hover:bg-white/[0.03] transition-all cursor-pointer text-left w-full"
                      >
                      ...
                      <button 
                        ...
                        className="flex items-center gap-2.5 w-full px-2.5 py-2 text-xs text-red-400 hover:text-red-300 hover:bg-red-500/10 rounded-lg transition-all mt-1.5 cursor-pointer border border-transparent text-left w-full"
                      >

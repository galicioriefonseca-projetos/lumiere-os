...
const PLAN_CATALOG = [
  { id: 'essential', name: 'Essencial', description: 'Operação sem improviso para organizar a rotina.', price: 197, semiannualPrice: 1064, annualPrice: 2009, billingCycle: 'MONTHLY', trialDays: 7, features: ['Agenda completa', 'Clientes e serviços', 'Comandas', 'Controle básico de caixa', 'Agendamento online', 'Dashboard operacional', 'Relatórios básicos', 'Suporte padrão'], active: true, displayOrder: 1, color: '#3b82f6', maxProfessionals: 5 },
  { id: 'professional', name: 'Gestão', description: 'Gestão de equipe e resultados para negócios que querem mais controle.', price: 397, semiannualPrice: 2144, annualPrice: 4049, billingCycle: 'MONTHLY', trialDays: 7, features: ['Tudo do Essencial', 'Gestão de equipe', 'Definição de metas', 'Comissões', 'Checklists', 'Avaliação de desempenho', 'CRM', 'Financeiro completo', 'Relatórios avançados', 'Dashboard de gestão', 'Suporte prioritário'], active: true, displayOrder: 2, color: '#d4af37', badge: 'Mais escolhido', maxProfessionals: 15 },
  { id: 'performance_plus', name: 'Performance', description: 'Inteligência, automação e decisões orientadas por dados.', price: 597, semiannualPrice: 3223, annualPrice: 6089, billingCycle: 'MONTHLY', trialDays: 7, features: ['Tudo do Gestão', 'Lumi — IA', 'Insights automáticos', 'Análises financeiras avançadas', 'Indicadores inteligentes', 'Análise de desempenho da equipe', 'Relatórios gerenciais avançados', 'Automação avançada', 'Suporte prioritário'], active: true, displayOrder: 3, color: '#8b5cf6', maxProfessionals: 30 },
  { id: 'multiunit', name: 'Multiunidade', description: 'Gestão centralizada para operações com múltiplas unidades.', price: 897, semiannualPrice: 4844, annualPrice: 9149, billingCycle: 'MONTHLY', trialDays: 7, features: ['Tudo do Performance', 'Gestão multiunidade', 'Dashboard consolidado', 'Comparação entre unidades', 'Financeiro por unidade', 'Relatórios executivos', 'Gestão centralizada', 'Permissões avançadas', 'Suporte VIP'], active: true, displayOrder: 4, color: '#ec4899', maxProfessionals: 60 },
...
export default async function asaasSettingsHandler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    if (typeof body.apiKey === 'string' && body.apiKey.trim()) {
      ...
      if (cleanKey.startsWith('$aact_hmlg_')) mode = 'sandbox';

    ...
    try {
      ...
      if (apps.length > 0) {
        ...
        if (projectId && clientEmail && privateKey) {
          ...
          console.warn("[Lumiere Serverless] Aviso: Configurações explícitas do Firebase Admin SDK incompletas. Utilizando inicialização automática...");
          adminApp = firebaseAdmin.initializeApp({
      ...
      console.error("Erro ao inicializar Firebase Admin nas funções Serverless:", err);
      throw err;
    }
  }
  return adminApp;
